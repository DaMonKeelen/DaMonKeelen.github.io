...
_.last = function(array, number) {
   ...
   if (!Array.isArray(array)){
    //return [] if it is not
        return [];
        //check to see if number is not given or not a number
   } else if(number === undefined) {
        //return the last element in the <array> if its not
...
_.map = function(collection, func) {
 ...
 if (Array.isArray(collection)) {
     ...
     for (var key in collection) {
         myObj.push(func(collection[key], key, collection));
         }
     return myObj;
    }
...
_.every = function(collection, func) {
    ...
    //if undefined, return true id every element is truth -- false is falsey
    if(func === undefined) {
        //iterate through collection and test the element
        for (var i = 0; i < collection.length; i++) {
            //test element to be false
...
_.reduce = function(array, func, seed) {
   ...
   if (seed !== undefined) {
       //if it does exist, then loop through the array
       for (var i = 0; i < array.length; i++) {
           //reassign seed to be value of function call
           //call the func on seed, value, index
